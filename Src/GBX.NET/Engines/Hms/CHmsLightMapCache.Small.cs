...
public partial class CHmsLightMapCache
{
    ...
    public class Small
    {
        ...
        public void ReadWrite(int version, ref CHmsLightMapCache? lightmapCache, IEnumerable<Frame>? lightmapFrames, GbxReaderWriter rw)
        {
            ...
            if (version >= 3)
            {
                ...
                if (version >= 4)
                {
                    ...
                    else if (lightmapFrames is not null)
                    {
